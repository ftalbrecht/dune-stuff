...
class DomainIndicator : public LocalizableFunctionInterface<E, D, d, R, r, rC>
{
  DomainIndicator()
  {
...
class DomainIndicator<E, D, d, R, 1> : public LocalizableFunctionInterface<E, D, d, R, 1>
{
...
template <class E, class D, size_t d, class R, size_t r, size_t rC = 1>
class LevelIndicator : public LocalizableFunctionInterface<E, D, d, R, rC>,
                       Stuff::Common::ConstStorageProvider<LocalizableFunctionInterface<E, D, d, R, rC>>
{
  ...
  class Localfunction : public LocalfunctionInterface<E, D, d, R, rC>
  {
  ...
  public:
    ...
    Localfunction(const LocalizableFunctionInterface<E, D, d, R, rC>& inducing_function, const EntityType& entity,
                  const RangeType& lower, const RangeType& upper, const RangeType& value)
      : InterfaceType(entity)
...
public:
  ...
  LevelIndicator(const LocalizableFunctionInterface<E, D, d, R, rC>& inducing_function, const RangeType& lower,
                 const RangeType& upper, const RangeType& value, const std::string nm = static_id())
